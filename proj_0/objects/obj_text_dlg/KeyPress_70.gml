...
var st=file_read_text(global.project_directory+@"\scripts\get_dlg_text_pos\get_dlg_text_pos.gml");
...
file_write_text(global.project_directory+@"\scripts\get_dlg_text_pos\get_dlg_text_pos.gml",st);
sd("save text "+string(ind)+" pos: "+otvet);