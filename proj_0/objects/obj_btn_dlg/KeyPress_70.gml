...
var st=file_read_text(global.project_directory+@"\scripts\get_dlg_btn_pos\get_dlg_btn_pos.gml");
...
file_write_text(global.project_directory+@"\scripts\get_dlg_btn_pos\get_dlg_btn_pos.gml",st);
sd("save btn "+string(ind)+" pos: "+otvet);